...
export type Witnesses<PS> = {
  getSupplier(context: __compactRuntime.WitnessContext<Ledger, PS>): [PS, Uint8Array];
...
export type ImpureCircuits<PS> = {
  createTender(context: __compactRuntime.CircuitContext<PS>, id_0: Uint8Array): __compactRuntime.CircuitResults<PS, []>;
  ...
  awardTender(context: __compactRuntime.CircuitContext<PS>,
