...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.getSupplier) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named getSupplier');
    }
    ...
    this.circuits = {
      createTender: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`createTender: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        ...
        const result_0 = this._createTender_0(context, partialProofData, id_0);
      ...
      submitBid: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('submitBid',
                                     'argument 1 (as invoked from Typescript)',
                                     'procurement.compact line 41 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
      ...
      closeTender: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('closeTender',
                                     'argument 1 (as invoked from Typescript)',
                                     'procurement.compact line 54 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
      ...
      awardTender: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`awardTender: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const winnerCommitment_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('awardTender',
                                     'argument 1 (as invoked from Typescript)',
                                     'procurement.compact line 59 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = this._awardTender_0(context,
                                             partialProofData,
                                             winnerCommitment_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
    ...
    this.impureCircuits = {
      ...
      awardTender: this.circuits.awardTender
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('awardTender', new __compactRuntime.ContractOperation());
  ...
  _getSupplier_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.getSupplier(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('getSupplier',
                                 'return value',
                                 'procurement.compact line 26 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _getBidAmount_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('getBidAmount',
                                 'return value',
                                 'procurement.compact line 27 char 1',
  ...
  _getSecret_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('getSecret',
                                 'return value',
                                 'procurement.compact line 28 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _getNonce_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('getNonce',
                                 'return value',
                                 'procurement.compact line 29 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _createTender_0(context, partialProofData, id_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
  ...
  _submitBid_0(context, partialProofData) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            0,
                            'Tender is not open');
    const supplier_0 = this._getSupplier_0(context, partialProofData);
  ...
  _awardTender_0(context, partialProofData, winnerCommitment_0) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
                            ...
                            ===
                            1,
                            'Tender must be closed to award');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
